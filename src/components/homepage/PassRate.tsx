...
export function PassHate() {
  return (
    <section
      id="passHate"
      className="relative flex h-[60rem] items-end justify-end overflow-y-hidden bg-red-900 bg-woman-happy bg-[center_0] bg-no-repeat p-12 text-gray-100 [background-size:auto_60%] sm:[background-size:auto_80%] md:h-[37.5rem] md:items-center md:bg-[-14rem_0] md:[background-size:auto_120%] lg:bg-[-18rem_-3rem] lg:px-16 lg:[background-size:auto_150%] xl:px-20"
    >
